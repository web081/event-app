...
const ReviewForm = ({ venueId, onSuccess, initialData = null }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (initialData) {
        await axios.put(
          `${backendURL}/api/venue/reviews/${initialData._id}`,
          data
        );
        showAlert("Review updated successfully!");
      } else {
        await axios.post(`${backendURL}/api/venue/reviews`, data);
      ...
      if (errorMessage.includes("already reviewed")) {
        showAlert("You have already reviewed this venue", "destructive");
      } else {
...
const ReviewSectionVenue = ({ venueId }) => {
  ...
  const fetchReviews = async () => {
    try {
      ...
      const { data } = await axios.get(
        `${backendURL}/api/getVenueReviews/${venueId}`
      );
  ...
  const handleDelete = async (reviewId) => {
    try {
      await axios.delete(`${backendURL}/api/venue/deleteReview/${reviewId}`, {
...
export default ReviewSectionVenue;
