          ...
          <div className="max-w-6xl mx-auto h-full flex flex-col justify-end p-6">
            ...
            <div className="flex items-center gap-4 text-white/90">
              ...
              <div className="flex items-center gap-2 text-white">
                ...
                <span>
                  {venue.amenities?.isFurnished ? "Furnished" : "Not Furnished"}
                </span>
              </div>
            </div>
          </div>
                  ...
                  <div>
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      ...
                      <div className="flex items-center gap-2 text-gray-600">
                        ...
                        <span>
                          <span>
                            {venue.amenities?.hasToilet ? "Yes" : "No"}
                          </span>
                        </span>
                      </div>
                      <div className="flex items-center gap-2 text-gray-600">
                        ...
                        <span>
                          <span>{venue.amenities?.hasAC ? "Yes" : "No"}</span>
                        </span>
                      </div>
                      <div className="flex items-center gap-2 text-gray-600">
                        <Bath className="w-5 h-5 text-red-600" />
                        ...
                        <span>
                          <span>
                            {venue.amenities?.hasBathroom ? "Yes" : "No"}
                          </span>
                        </span>
                      </div>
                      ...
                      <div className="flex items-center gap-2 text-gray-600">
                        ...
                        <span>
                          <span>
                            {venue.amenities?.hasChangingRoom ? "Yes" : "No"}
                          </span>
                        </span>
                      </div>
                    </div>
                  ...
                  <div>
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="flex items-center gap-2 text-gray-600">
                        ...
                        <span>
                          Payment Duration:{""}
                          {venue.pricingDetails.paymentDuration} days
                        </span>
                      </div>
                    </div>
                  </div>
