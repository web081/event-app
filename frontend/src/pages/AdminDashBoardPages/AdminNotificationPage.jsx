...
const AdminNotificationPage = () => {
  ...
  const markAsRead = async (id) => {
    try {
      ...
      const { data } = await axios.patch(
        `${backendURL}/api/notifications/markNotificationAsReadforAdmin/${id}`,
        {},
        axiosConfig
      );
  ...
  const confirmDelete = async () => {
    ...
    try {
      await axios.delete(
        `${backendURL}/api/notifications/deleteNotificationForAdmin/${selectedNotification._id}`,
        axiosConfig
      );
      setNotifications((prevNotifications) =>
  ...
  const markAllAsRead = async () => {
    try {
      const { data } = await axios.patch(
        `${backendURL}/api/notifications/markAllNotificationsAsReadFOrAdmin`,
        {},
        axiosConfig
      );
